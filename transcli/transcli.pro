...
win32 {
    ...
    LIBS += -L$$_PRO_FILE_PWD_/../lib/win32/intel -L$$_PRO_FILE_PWD_/../lib/win32 -ltransnode -lfaac -llame -lx264 -lx265 -lxvidcore -leac3enc -lfdk-aac -lsamplerate -lwatermark -lcommon -lstrpro -lxml2 -liconv -lWSock32 -luser32 -lzlib1
    DESTDIR = $$_PRO_FILE_PWD_/../bin/win32
}

unix {
    DEPENDPATH += $$_PRO_FILE_PWD_/../lib/x64_linux
    LIBS += -L$$_PRO_FILE_PWD_/../lib/x64_linux -ltransnode -lfaac -llame -lx264 -lx265 -lxvidcore -leac3enc -lfdk-aac -lsamplerate -lwatermark -lcommon -lstrpro -lxml2 -liconv -lc -lzstatic -lpthread -ldl -lirc
