...
<presets>\n\
    <MediaCoderPrefs name=\"PPTV-Mp4-Template\" id=\"1\">\n\
	    ...
	    <node key=\"videoenc.x265.merange\">60</node>\n\
	    <node key=\"videoenc.x265.subme\">5</node>\n\
		...
		<node key=\"videoenc.x265.tskipFast\">true</node>\n\
		<node key=\"videoenc.x265.signHide\">true</node>\n\
		<node key=\"videoenc.x265.badapt\">1</node>\n\
		<node key=\"videoenc.x265.weightp\">true</node>\n\
		...
		<node key=\"videoenc.x265.lookahead\">40</node>\n\
