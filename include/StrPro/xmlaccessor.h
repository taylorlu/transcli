...
public:
	...
	virtual void FreeDump(char** buffer) = 0;
	...
	virtual void* appendChild(void* node) = 0;
	...
	virtual float getNodeValueFloat(int index=0) = 0;
	...
	virtual float getChildNodeValueFloat(const char* name, const char* attrname = 0, const char* attrvalue = 0, int index = 0) = 0;
	virtual void setChildNodeValue(const char* name, const char* nodeVal, const char* attrname = 0, const char* attrvalue = 0) = 0;
	virtual void setChildNodeValue(const char* name, int nodeVal, const char* attrname = 0, const char* attrvalue = 0) = 0;
	virtual void setChildNodeValue(const char* name, float nodeVal, const char* attrname = 0, const char* attrvalue = 0) = 0;
