...
typedef enum {
	...
	EC_XMLRPC_INVALID_PAYLOAD = 26,		// xmlrpc: invalid payload
	...
	EC_INVILID_AUDIO_ATTRIB = 30,			// Invalid audio attribute
	EC_INVILID_VIDEO_ATTRIB = 31,			// Invalid video attribute
	...
	EC_BAD_AV_DATA = 36,				// Output mp4 audio/video data corrupt(No frame/audio element 0.0)
