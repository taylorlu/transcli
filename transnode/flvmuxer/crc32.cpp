...
unsigned int crcTable[256] = {
        ...
        0x6b6b51f, 0x9fbfe4a5, 0xe8b8d433,
        0x7807c9a2, 0xf00f934, 0x9609a88e, 
        ...
        0xedb88320, 
        0x9abfb3b6, 0x3b6e20c, 0x74b1d29a, 0xead54739, 0x9dd277af, 0x4db2615, 
        0x73dc1683,
        ...
        0x95bf4a82, 
        0xe2b87a14, 0x7bb12bae, 0xcb61b38, 0x92d28e9b, 0xe5d5be0d, 0x7cdcefb7, 
        0xbdbdf21,
...
unsigned int getcrc(char *c, int len)
{
        ...
        {
                crc = ((crc >> 8) & 
                        0x00FFFFFF) ^ crcTable[ (crc^ *c) & 0xFF ];
                ++c;
        }
